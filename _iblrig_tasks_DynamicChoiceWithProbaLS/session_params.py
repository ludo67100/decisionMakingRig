...
class SessionParamHandler(object):
    ...
    def __init__(self, task_settings, user_settings, debug=False, fmake=True):
        ...
        #REWARD DIRECTION LS
        #=====================================================================
        self.PRESET_REWARD_DIRECTIONS = self.PRESET_REWARD_DIRECTIONS
    ...
    #ADD LS: list for reward magnitude (-1: left; -:right)
    #/!\ add 0 on index 1, for any obscure reason the self.trial_num in tph goes from to 0 to 2 directly when using custom list
    #TODO : fix this at some point 

    #TODO: create a function that builds the reward magnitude list based on NTRIALS  
    def reward_magnitude(self):
        #Update May 2022 LS
        #Defiition is now passed as global sph from values in task_settings.py

        return self.PRESET_REWARD_DIRECTIONS
